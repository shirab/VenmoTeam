...
- (void)viewDidLoad
{
    ...
    member0.Photo = [UIImage imageNamed:@"Kortina.png"];
    ...
    member1.Photo = [UIImage imageNamed:@"Magdon-Ismail.png"];
    ...
    member2.Photo = [UIImage imageNamed:@"Staub.png"];
    ...
    member3.Photo = [UIImage imageNamed:@"Di Pasquale.png"];
    ...
    member4.Photo = [UIImage imageNamed:@"Vaughan.png"];
    ...
    member5.Photo = [UIImage imageNamed:@"Connor.png"];
    ...
    member6.Photo = [UIImage imageNamed:@"Graham.png"];
    ...
    member7.Photo = [UIImage imageNamed:@"Bentert.png"];
    ...
    member8.Photo = [UIImage imageNamed:@"Garfinkel.png"];
    ...
    member9.Photo = [UIImage imageNamed:@"Sherwood.png"];
    ...
    member10.Photo = [UIImage imageNamed:@"McFarlane.png"];
    ...
    member11.Photo = [UIImage imageNamed:@"Cosson.png"];
    ...
    member12.Photo = [UIImage imageNamed:@"Kimchi.png"];
    ...
    member13.Photo = [UIImage imageNamed:@"Hodelin.png"];
    ...
    member14.Photo = [UIImage imageNamed:@"Hamilton.png"];
    ...
    member15.Photo = [UIImage imageNamed:@"Zakin.png"];
    ...
    member16.Photo = [UIImage imageNamed:@"Greaney.png"];
    ...
    member17.Photo = [UIImage imageNamed:@"Hitti.png"];
    ...
    member18.Photo = [UIImage imageNamed:@"Einfrank.png"];
    ...
    member19.Photo = [UIImage imageNamed:@"Majeed.png"];
    ...
    member20.Photo = [UIImage imageNamed:@"Mirman.png"];
    ...
    member21.Photo = [UIImage imageNamed:@"Kristensen.png"];
    ...
    member22.Photo = [UIImage imageNamed:@"Ansar.png"];
    ...
    member23.Photo = [UIImage imageNamed:@"Brettman.png"];
    ...
    UIImage *img = [UIImage imageNamed:@"venmoteam3.png"];
